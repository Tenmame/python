...
import getopt
# D:\fmw_12.2.1.1.0_wls_quick_Disk1_1of1\wls12210\wlserver\common\bin\wlst.cmd deploy_on_weblogic.py -u weblogic -p weblogic1 -a t3://localhost:7001 -n catear -f D:\catear.ear -t AdminServer
#========================
#Usage Section
#========================
def usage():
